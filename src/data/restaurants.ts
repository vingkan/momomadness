...
export const RESTAURANTS: Restaurant[] = [
  ...
  { seed: 16, name: 'Dumpling Baby China Bistro',  neighborhood: 'Inner Richmond',     division: 'North', beliScore: 6.6, beliRatings: 227,   menuItemA: 'Dumplings in Chili Oil Sauce (C)',           menuItemB: 'Vegetable Potsticker (V)',                    address: '3751 Geary Blvd, San Francisco, CA 94118',        coordinates: { lat: 37.7818, lng: -122.4962 } },
  { seed: 6,  name: 'Dumpling Time',               neighborhood: 'SoMa',               division: 'South', beliScore: 7.5, beliRatings: 3936,  menuItemA: 'Boiled Lamb Dumpling (L)',                   menuItemB: 'Boiled Vegetable Dumpling (V)',                address: '11 Division St, San Francisco, CA 94103',         coordinates: { lat: 37.7692, lng: -122.4107 } },
  { seed: 8,  name: 'Bao',                         neighborhood: 'Mission',            division: 'South', beliScore: 7.9, beliRatings: 2706,  menuItemA: 'Bi Feng Tang Har Gow (S)',                   menuItemB: 'Pan Fried Vegetarian Pot Sticker (V)',        address: '590 Valencia St, San Francisco, CA 94110',        coordinates: { lat: 37.7634, lng: -122.4217 } },
  { seed: 12, name: 'Dumpling Kitchen',            neighborhood: 'Castro',             division: 'South', beliScore: 7.6, beliRatings: 368,   menuItemA: 'Pork & Napa Cabbage Potsticker (P)',         menuItemB: 'Boiled Chicken & Corn Dumpling (C)',          address: '544 Castro St, San Francisco, CA 94114',          coordinates: { lat: 37.7607, lng: -122.4350 } },
  { seed: 13, name: 'United Dumplings',            neighborhood: 'Bernal Heights',     division: 'South', beliScore: 7.0, beliRatings: 336,   menuItemA: 'Korean BBQ Beef Dumplings (B)',              menuItemB: 'Vegetarian Dumpling (V)',                     address: '525 Cortland Ave, San Francisco, CA 94110',       coordinates: { lat: 37.7394, lng: -122.4168 } },
];
